...
const ManageTestimonials = () => {
  const [testimonials, setTestimonials] = useState<Testimonial[]>([
    ...
    },
    {
      ...
      testimonial: 'Excellent courses and instructors.',
      status: 'Active',
    },
    {
      id: '3',
      ...
      testimonial: 'Highly recommend this platform!',
      status: 'Active',
    },
    {
      id: '4',
      ...
      testimonial: 'Best learning experience I\'ve had.',
      status: 'Active',
    },
  ]);
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          testimonial.status === 'Active' ? 'bg-primary' : 'bg-gray-300'
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                            testimonial.status === 'Active' ? 'translate-x-6' : 'translate-x-1'
                          }`}
                        />
                      </button>
                    </div>
